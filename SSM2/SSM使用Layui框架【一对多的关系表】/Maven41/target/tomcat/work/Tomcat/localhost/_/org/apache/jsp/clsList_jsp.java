 ...
 * Generated at: 2019-07-27 06:17:14 UTC
...
public final class clsList_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t    elem: '#test'\r\n");
      out.write("\t\t    ,url:'/cls/findAll'\t\t//绝对路径\r\n");
      out.write("\t\t    ,toolbar: '#toolbarDemo'\r\n");
      out.write("\t\t    ,title: '班级数据表'\r\n");
      out.write("\t\t    ,totalRow: true\r\n");
      out.write("\t\t    ,cols: [[\r\n");
      out.write("\t\t    \t {type:'checkbox'}\r\n");
      out.write("\t\t      ,{field:'cid', title:'ID', width:120, sort: true}\r\n");
      out.write("\t\t      ,{field:'cname', title:'班级名', width:150, edit: 'text'}\r\n");
      ...
      out.write("\t\t        \tarr[i] = data[i].cid;\r\n");
      out.write("\t\t        }\r\n");
      out.write("\t\t       // alert(arr);\r\n");
      out.write("\t\t       // layer.msg('选中了：'+ data.length + ' 个');\r\n");
      out.write("\t\t       //\t执行批量删除！\r\n");
      out.write("\t\t       $.ajax({\r\n");
      out.write("\t\t    \t   url:\"/cls/deleteClsAll\",\r\n");
      out.write("\t\t    \t   data:\"uid=\"+arr,\r\n");
      ...
      out.write("\t\t    \t\t   layer.msg('执行批量删除访问失败！');\r\n");
      out.write("\t\t    \t   }\r\n");
      out.write("\t\t       });\r\n");
      out.write("\t\t       \r\n");
      out.write("\t\t      break;\r\n");
      ...
      out.write("\t\t        layer.msg('ID：'+ data.cid + ' 的查看操作');\r\n");
      out.write("\t\t      } else if(obj.event === 'del'){\t\t//监听删除按钮\r\n");
      out.write("\t\t      layer.confirm('真的删除行么', function(index){\r\n");
      out.write("\t\t    \t  layer.msg('ID：'+ data.cid + ' 的删除操作');\r\n");
      out.write("\t\t    \t  $.ajax({\r\n");
      out.write("\t\t    \t\t url:\"/cls/deleteCls\",\t\t//执行异步删除， 不刷新当前页面\r\n");
      out.write("\t\t    \t\t data:\"cid=\"+data.cid,\r\n");
      out.write("\t\t    \t\t dataType:\"text\",\r\n");
      out.write("\t\t    \t\t type:\"GET\",\r\n");
      out.write("\t\t    \t\t success:function(data){\r\n");
      ...
      out.write("\t\t    \t\t\t\t layer.msg('当前班级下有学生，删除失败！');\r\n");
      out.write("\t\t    \t\t\t}\r\n");
      out.write("\t\t    \t\t },\r\n");
      out.write("\t\t    \t\t error:function(){\r\n");
      ...
      out.write("\t\t\t\t\tarea:[\"480px\", \"260px\"],\t//设置宽，高！\r\n");
      ...
      out.write("\t\t          \"cid\": data.cid // \"name\": \"value\"\r\n");
      ...
      out.write("\t\t\t\t<form class=\"layui-form\" action=\"/cls/updateCls\" method=\"post\"   lay-filter=\"example\">\t\t<!-- lay-filter=\"example\"  设置表单初始值  -->\r\n");
      out.write("\t\t\t\t\t  <div class=\"layui-form-item\">   <!-- layui-form-item 表示一行 -->\r\n");
      out.write("\t\t\t\t\t    <label class=\"layui-form-label\">cid</label>\r\n");
      out.write("\t\t\t\t\t    <div class=\"layui-input-block\">\r\n");
      out.write("\t\t\t\t\t      <input type=\"text\" name=\"cid\" required  lay-verify=\"required\"  autocomplete=\"off\" class=\"layui-input\" readonly=\"readonly\">\r\n");
      out.write("\t\t\t\t\t    </div>\r\n");
      out.write("\t\t\t\t\t  </div>\r\n");
      out.write("\t\t\t\t\t  \r\n");
      out.write("\t\t\t\t\t  <div class=\"layui-form-item\">   <!-- layui-form-item 表示一行 -->\r\n");
      out.write("\t\t\t\t\t    <label class=\"layui-form-label\">cname</label>\r\n");
      out.write("\t\t\t\t\t    <div class=\"layui-input-block\">\r\n");
      out.write("\t\t\t\t\t      <input type=\"text\" name=\"cname\" required  lay-verify=\"required\" placeholder=\"请输入班级名\" autocomplete=\"off\" class=\"layui-input\">\r\n");
      out.write("\t\t\t\t\t    </div>\r\n");
      out.write("\t\t\t\t\t  </div>\r\n");
      out.write("\t\t\t\t\t\r\n");
