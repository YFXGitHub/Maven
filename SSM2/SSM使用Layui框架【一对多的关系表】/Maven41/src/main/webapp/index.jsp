...
<head>
	<meta charset="UTF-8">
	<title>Cls & Stu 一对多表结构 用Layui框架搭建页面</title>
      ...
      <div id="side-nav">
        <ul id="nav">
             <li >
                ...
                <ul class="sub-menu">
                    <li><a _href="welcome.jsp"><i class="iconfont">&#xe6a7;</i><cite>控制台</cite></a></li >
                </ul>
            </li>
             <li >
                <a href="javascript:;">
                ...
                <ul class="sub-menu">
                    <li><a _href="clsList.jsp"><i class="layui-icon">&#xe630;</i><cite>Cls 列表</cite></a></li>
                    <li><a _href="stuList.jsp"><i class="layui-icon">&#xe665;</i><cite>Stu 列表</cite></a></li>
                    <!-- 每个的href="" 标签中都有一个html 页面 -->
            ...
            <li>
                <a href="javascript:;"> <i class="layui-icon layui-icon-flag"></i>
					<cite>组件页面</cite>
